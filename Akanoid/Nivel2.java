...
public class Nivel2 extends JPanel implements ActionListener, KeyListener{
    ...
    //ball
    private int ball = 20;  
    private int ballVelX = 8;
    private int ballVelY = 8;
    ...
    private Bloque[] bloquesFila1, bloquesFila2; //clase bloques
    ...
    public Nivel2() {
     ...
     // Configuración de bloques para la primera fila
        ...
        for (int i = 0; i < bloquesFila2.length; i++) {
            bloquesFila2[i] = new Bloque(width - 750 + i * 100, height - 450, 50, 20); // Define las coordenadas y dimensiones de la segunda fila
        }
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (todosBloquesDestruidos && score == 250) {
                tiempo.stop();
