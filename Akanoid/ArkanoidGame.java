...
public class ArkanoidGame extends JPanel implements ActionListener, KeyListener{
    ...
    //posicion ball
    private int ballPosX = width / 2 - ball / 2;
    private int ballPosY = height / 2 - ball / 2;
    //elementos
    private int vidas = 3;
    private int score = 0;
            ...
            if (ballPosY >= height - ball) {
                ...
                if (vidas == 0) {
                    ...
                    System.exit(0);   
                	    ...
                	    // Reubicar la bola en una posici�n aleatoria en el panel
            ...
            for (Bloque bloque : bloques) {
                if (bloque.visible) {
                    if (ballPosX + ball >= bloque.x &&
                        ...
                        // Colisi�n detectada, cambia la direcci�n de la pelota y oculta el bloque
                    	ballVelY = -ballVelY;
